        ...
        void itShouldUpdateOrder() throws Exception {
                ...
                mockMvc.perform(put("/api/v1/order/" + order1.getOrderId()).contentType(MediaType.APPLICATION_JSON)
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.customer.customerId",
                                                Is.is("846e1a32-f831-4bee-a6bc-673b5f901d7b")))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.orderNumber", Is.is(123123)))
                                .andExpect(status().isOk()).andReturn();
        }

        @Test
        void itShouldNotUpdateOrder() throws Exception {
                JSONObject my_obj = new JSONObject();
